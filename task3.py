class complex_number:
    ...
    def __sub__(self, other):
        ...
        return complex_number("", real_dif, imag_dif)
    def __str__(self):
        return f"{self.real} + {self.imaginary}i"
    def __mul__ (self, other):
        ...
        return complex_number("", real_pro, imag_pro)
    def __str__(self):
        return f"{self.real} + {self.imaginary}i"
    def __truediv__  (self, other):
        ...
        return complex_number("", real_quo, imag_quo)
    def __str__(self):
        return f"{self.real} + {self.imaginary}i"

x = input("Enter the first complex number: ")
y = input("Enter the second complex number: ")
num1 = complex_number(x)  
num2 = complex_number(y) 
